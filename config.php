<?php
//Voobly API Configuration
define('API_URL','http://www.voobly.com/api/'); //Path to Voobly API
define('API_KEY','ENTER_YOUR_KEY_HERE'); //Key for API access, get our own for free by sending a PM to Rambit (http://www.voobly.com/profile/view/112)
